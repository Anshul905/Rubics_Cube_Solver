...
char GenericRubicsCube::getColorLetter(COLOR color) {
    switch (color) {
        case COLOR::BLUE:
            return 'B';
        case COLOR::GREEN:
...
string GenericRubicsCube::getMove(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return "L";
        case MOVE::LPRIME:
...
GenericRubicsCube &GenericRubicsCube::move(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return this->l();
        case MOVE::LPRIME:
...
GenericRubicsCube &GenericRubicsCube::invert(MOVE ind) {
    switch (ind) {
        case MOVE::L:
            return this->lPrime();
        case MOVE::LPRIME:
...
void GenericRubicsCube::print() const {
    cout << "Rubik's Cube:\n\n";
...
vector<GenericRubicsCube::MOVE> GenericRubicsCube::randomShuffleCube(unsigned int times) {
...
string GenericRubicsCube::getCornerColorString(uint8_t ind) const {
    string str = "";
...
uint8_t GenericRubicsCube::getCornerIndex(uint8_t ind) const {
...
uint8_t GenericRubicsCube::getCornerOrientation(uint8_t ind) const {
    string corner = getCornerColorString(ind);
