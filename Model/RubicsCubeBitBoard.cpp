...
class RubiksCubeBitboard : public GenericRubicsCube {
...
public:
    ...
    GenericRubicsCube &uPrime() override {
        this->u();
        this->u();
        this->u();
    ...
    GenericRubicsCube &lPrime() override {
        this->l();
        this->l();
        this->l();
    ...
    GenericRubicsCube &fPrime() override {
        this->f();
        this->f();
        this->f();
        return *this;
    ...
    GenericRubicsCube &rPrime() override {
        this->r();
        this->r();
        this->r();
    ...
    GenericRubicsCube &bPrime() override {
        this->b();
        this->b();
        this->b();
    ...
    GenericRubicsCube &dPrime() override {
        this->d();
        this->d();
        this->d();
